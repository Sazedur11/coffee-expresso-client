    ...
    <>
      ...
      <div className="bg-white pt-10 pb-20">
        <div className="w-4/5 mx-auto">
          <Link className="w-33 text-[#374151] text-shadow-lg/30 font-Rancho px-4 py-2 rounded-sm hover:bg-[#D2B48C] flex items-center gap-2" to={"/"}>
          ...
          <div className="bg-[#F4F3F0] px-10 py-15">
            ...
            <form>
              ...
              <input className="text-[#331A15] font-Rancho btn btn-block bg-[#D2B48C]" type="submit" value="Add coffee" />
            </form>
          </div>
        </div>
      </div>
